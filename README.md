...
1. **Клонирование репозитория:**
    ```bash
    git clone https://github.com/Ilyasir/market-analytics-pipeline.git
    cd market-analytics-pipeline/
    ```
...
5. **Запуск ETL-процессов**
    ...
    В интерфейсе Airflow включите все DAG'и. Проход пайплайна может занимать 30-40 минут, так как включает в себя полный цикл парсинга данных (обработка ~34 000 объектов), их очистку, типизацию и последующую загрузку в DWH. После завершения работы DAG'ов вы можете зарегистрироваться в Metabase и приступить к созданию дашбордов.
